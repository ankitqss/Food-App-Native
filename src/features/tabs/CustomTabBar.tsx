...
import { useSharedState } from './SharedContent';
...
const CustomTabBar: FC<BottomTabBarProps> = props => {
  ...
  const isLiveTavFocused = state.routes[state.index].name === 'Live';
      ...
      <Animated.View
        style={[
          ...
          animatedStyle,
          {
            ...
            backgroundColor: isLiveTavFocused ? Colors.dark : Colors.background,
          },
        ]}
      >
        ...
        <Animated.View
          style={[
            ...
            indicatorStyle,
            {
              backgroundColor: isLiveTavFocused
                ? '#fff'
                : isVegMode
                ? Colors.active
                : Colors.primary,
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            Alert.alert('Hi this is for testing purpose');
          }}
        >
          <Image
